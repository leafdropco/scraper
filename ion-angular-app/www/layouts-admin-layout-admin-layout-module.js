...
module.exports = "\n<div class=\"content lookup top row\">\n  <div class=\" col-12\">\n    <div class=\" card card-chart\">\n      <div class=\"lookup-container\">\n        <h4>ACCOUNT LOOKUP</h4>\n        <div class=\"search-badge\" (click)=\"handleSubmit($event)\" *ngIf=\"firstUnText\">\n            <i class=\" tim-icons icon-zoom-split\" *ngIf=\"!loading\"> </i>\n            <i class=\" tim-icons icon-refresh-02 rotating\" *ngIf=\"loading\"> </i>\n        </div>\n        <form>\n          <div class=\" row\">\n            <input class=\"lookup-form form-control\" placeholder=\"@username1\" type=\"text\" (keyup)=\"firstUn($event)\" />\n            <input class=\"lookup-form form-control\" placeholder=\"@username2 (optional)\" type=\"text\" (keyup)=\"secondUn($event)\" />\n          </div>\n        </form>\n      </div>\n    </div>\n  </div>\n</div>\n\n<div class=\"content lookup row\" *ngIf=\"results !== 'empty'\">\n    <div class=\" col-12\">\n      <div class=\" card card-chart\">\n        <div class=\"lookup-container\">\n          <div class=\"url row\">\n            <h4>Results</h4>\n            <p>For: {{ results.url }}</p>\n          </div>\n          <div class=\"row\">\n            <div class=\" table-responsive\">\n                <table class=\" table tablesorter\" id=\"\">\n                  <thead class=\" text-primary\">\n                    <tr>\n                      <th>Followers</th>\n                      <th>Following</th>\n                      <th>Posts</th>\n                    </tr>\n                  </thead>\n                  <tbody>\n                    <tr>\n                      <td>{{ results.followers }}</td>\n                      <td>{{ results.following }}</td>\n                      <td>{{ results.posts }}</td>\n                    </tr>\n                  </tbody>\n                </table>\n              </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>"
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.handleSubmit = function (evt) {
        var _this = this;
        evt.preventDefault();
        this.loading = true;
        this.http.get("https://us-central1-scraper-58e5f.cloudfunctions.net/widgets/posts/images/" + this.firstUnText)
            ...
            _this.results = res;
            _this.loading = false;
            console.table(_this.results);
        });
    };
    DashboardComponent.prototype.firstUn = function (evt) {
        this.firstUnText = evt.target.value;
    };
    DashboardComponent.prototype.secondUn = function (evt) {
